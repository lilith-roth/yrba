...
To use YRBA with SFTP uploads configure the protocol in your `config.toml` to
SFTP, and set up the username to log in with.
...
logging in with password, in case private key authentication fails.
